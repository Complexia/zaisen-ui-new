  ...
  return (
    <div className="ml-auto py-4">
      ...
      <div className="w-full mx-auto flex justify-end mt-5">
        ...
        <button
            className="bg-gray-300 rounded-full p-2 focus:outline-none"
      ...
      {/* Dropdown */}
      {isDropdownOpen && (
        <div className="absolute top-10 right-0 bg-white rounded shadow-md p-4">
          {/* Notification Items */}
          <ul>
            {/* Map over your notifications and render them as list items */}
          </ul>
        </div>
      )}
    </div>
